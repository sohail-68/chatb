...
// Follow
router.post('/follow-request/:id', isAuthenticated, sendOrCancelFollowRequest);
router.post('/users/follow-request/respond', isAuthenticated, respondToFollowRequest);
